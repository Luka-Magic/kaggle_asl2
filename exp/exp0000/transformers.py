...
class EncoderEmbedding(nn.Module):
    ...
    def __init__(self, embed_dim, input_size, encoder_max_seq_length=512):
        '''
        Parameters
        ----------
        embed_dim: int
        ...
        self.position_encoder = PositionalEncoding(
            embed_dim, max_len=encoder_max_seq_length)
...
class DecoderEmbedding(nn.Module):
    ...
    def __init__(self, embed_dim, vocab_size=60, decoder_max_seq_length=32):
        '''
        Parameters
        ----------
        embed_dim: int
        ...
        self.position_encoder = PositionalEncoding(
            embed_dim, max_len=decoder_max_seq_length)
...
class Encoder(nn.Module):
    def __init__(self, input_size, encoder_max_seq_length, embed_dim, ffn_hidden, num_heads, drop_prob, num_layers):
        super().__init__()
        self.encoder_embedding = EncoderEmbedding(
            input_size, embed_dim, encoder_max_seq_length)
...
class Decoder(nn.Module):
    def __init__(self, vocab_size, decoder_max_seq_length, embed_dim, ffn_hidden, num_heads, drop_prob, num_layers):
        super().__init__()
        self.decoder_embedding = DecoderEmbedding(
            embed_dim, vocab_size, decoder_max_seq_length)
...
class Transformer(nn.Module):
    def __init__(self,
                 ...
                 num_layers):
        super().__init__()
        self.encoder = Encoder(input_size, encoder_max_seq_length, embed_dim,
                               ffn_hidden, num_heads, drop_prob, num_layers)
        self.decoder = Decoder(vocab_size, decoder_max_seq_length, embed_dim,
                               ffn_hidden, num_heads, drop_prob, num_layers)
